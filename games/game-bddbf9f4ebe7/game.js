window.__iis_game_boot_ok = true;
      ...
      const CONFIG = {
        title: "AeroPilot: Flight Simulator",
        genre: "flight-simulation-3d",
        slug: "game-bddbf9f4ebe7",
        mode: "flight_sim_3d",
        cameraModel: "chase",
...
runtimeModules.camera_fx = { enabled: true };
      ...
      const state = {
        ...
        progress: {
          ...
          waveTimer: 0,
          spawnCadence: 1.35,
          objective: "Navigate waypoints and maintain stable vector",
          time: 0,
        },
        enemies: [],
        projectiles: [],
      ...
      function restartGame() {
        ...
        state.progress.objective = "Navigate waypoints and maintain stable vector";
        state.enemies = [];
        state.projectiles = [];
        state.interactives = [];
        state.checkpoints = [];
