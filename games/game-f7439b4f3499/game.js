window.__iis_game_boot_ok = true;
      const CONFIG = {"mode": "topdown_roguelike_shooter", "title": "Metro Gunner: Urban Sweep", "genre": "top-down-twin-stick-shooter", "slug": "game-f7439b4f3499", "accentColor": "#0EA5E9", "viewportWidth": 1280, "viewportHeight": 720, "safeAreaPadding": 24, "minFontSizePx": 14, "textOverflowPolicy": "ellipsis-clamp", "assetPack": {"name": "fantasy_topdown", "bg_top": "#111827", "bg_bottom": "#090b16", "horizon": "#1a1532", "track": "#151427", "hud_primary": "#e2e8f0", "hud_muted": "#93c5fd", "player_primary": "#22c55e", "player_secondary": "#0f172a", "enemy_primary": "#f8fafc", "enemy_elite": "#f59e0b", "boost_color": "#a78bfa", "accent": "#0EA5E9", "particle": "#c4b5fd", "sfx_profile": "fantasy_arcade", "sprite_profile": "fantasy"}, "assetManifest": {"schema_version": 1, "pack_name": "fantasy_topdown", "genre_engine": "topdown_roguelike_shooter", "images": {"player": "./player.svg", "enemy": "./enemy.svg", "elite": "./elite.svg", "boost": "./boost.svg", "ring": "./ring.svg", "hazard": "./hazard.svg", "trail": "./trail.svg", "hud_frame": "./hud-frame.svg", "track_grid": "./track-grid.svg", "impact_flare": "./impact-flare.svg"}, "audio": {"profile": "fantasy_arcade"}, "asset_policy": {"mode": "procedural_threejs_first", "provider": "builtin_vector_pack", "external_image_generation": false}, "procedural_layers": ["gradient_background", "parallax_grid", "depth_fog", "particle_trails", "hud_glow_overlay", "decal_layers"], "asset_pipeline": {"automated": true, "source": "builtin_svg_asset_pipeline", "profile": "enhanced", "variant_count": 4, "selected_variant": "baseline-balanced", "selected_theme": "balanced", "selected_score": 69.4341, "selected_composed_score": 92.4341, "selected_memory_bonus": 23.0, "steps": ["derive_contract", "retrieve_prior_signals", "sample_visual_variants", "score_readability_contrast", "compose_variant_with_memory", "select_best_variant", "compile_svg_pack"], "candidates": [{"id": "baseline-balanced", "theme": "balanced", "score": 69.4341, "memory_bonus": 23.0, "composed_score": 92.4341}, {"id": "high-contrast-racing", "theme": "high-contrast", "score": 69.1785, "memory_bonus": 0.0, "composed_score": 69.1785}, {"id": "cinematic-glow", "theme": "cinematic", "score": 64.3846, "memory_bonus": 0.0, "composed_score": 64.3846}, {"id": "aggressive-arcade", "theme": "aggressive", "score": 68.0895, "memory_bonus": 0.0, "composed_score": 68.0895}], "retriever": {"enabled": true, "source": "pipeline_logs_v1", "preferred_variant_id": "baseline-balanced", "preferred_variant_theme": "balanced", "failure_reasons": ["cancelled_by_operator"], "failure_tokens": [], "sample_size": 1}}, "contract": {"min_image_assets": 5, "min_render_layers": 4, "min_animation_hooks": 3, "min_procedural_layers": 3}, "art_direction": {"style_tag": "cyberpunk-pixel-art", "motif": "neon-motion", "required_visual_keywords": ["neon-motion", "readable_silhouette", "high_contrast_hud"], "forbidden_visual_tokens": ["placeholder", "temp", "debug-ui", "plain-rectangle-only"], "asset_strategy_mode": "procedural_threejs_first", "asset_provider": "builtin_vector_pack", "external_image_generation": false, "asset_variant_count": 4, "asset_detail_tier": "enhanced"}}, "player_hp": 3, "player_speed": 350, "player_attack_cooldown": 0.2, "enemy_hp": 1, "enemy_speed_min": 150, "enemy_speed_max": 280, "enemy_spawn_rate": 0.4, "time_limit_sec": 180, "base_score_value": 10};
      const ASSET = {
        name: "neon_arcade",
        bg_top: "#08122f",
        bg_bottom: "#050915",
