window.__iis_game_boot_ok = true;
      const CONFIG = {"mode": "duel_brawler", "title": "Poly Punch 3D: Arena Clash", "genre": "3d-arena-brawler", "slug": "3d-93c818", "accentColor": "#0EA5E9", "viewportWidth": 1280, "viewportHeight": 720, "safeAreaPadding": 24, "minFontSizePx": 14, "textOverflowPolicy": "ellipsis-clamp", "assetPack": {"name": "duel_fighter", "bg_top": "#0e1423", "bg_bottom": "#050812", "horizon": "#1f2942", "track": "#0f1526", "hud_primary": "#e7ecf3", "hud_muted": "#93c5fd", "player_primary": "#3ad194", "player_secondary": "#0f172a", "enemy_primary": "#f9c0ca", "enemy_elite": "#f59e0b", "boost_color": "#22d3ee", "accent": "#0EA5E9", "particle": "#f8b924", "sfx_profile": "impact_duel", "sprite_profile": "comic"}, "assetManifest": {"schema_version": 1, "pack_name": "duel_fighter", "genre_engine": "duel_brawler", "images": {"player": "./player.svg", "enemy": "./enemy.svg", "elite": "./elite.svg", "boost": "./boost.svg", "ring": "./ring.svg", "hazard": "./hazard.svg", "trail": "./trail.svg", "hud_frame": "./hud-frame.svg", "track_grid": "./track-grid.svg", "impact_flare": "./impact-flare.svg"}, "audio": {"profile": "impact_duel"}, "asset_policy": {"mode": "procedural_threejs_first", "provider": "builtin_vector_pack", "external_image_generation": false}, "procedural_layers": ["gradient_background", "parallax_grid", "depth_fog", "particle_trails", "hud_glow_overlay", "decal_layers"], "asset_pipeline": {"automated": true, "source": "builtin_svg_asset_pipeline", "profile": "enhanced", "variant_count": 4, "selected_variant": "high-contrast-racing", "selected_theme": "high-contrast", "selected_score": 68.333, "selected_composed_score": 91.333, "selected_memory_bonus": 23.0, "steps": ["derive_contract", "retrieve_prior_signals", "sample_visual_variants", "score_readability_contrast", "compose_variant_with_memory", "select_best_variant", "compile_svg_pack"], "candidates": [{"id": "baseline-balanced", "theme": "balanced", "score": 67.4196, "memory_bonus": 0.0, "composed_score": 67.4196}, {"id": "high-contrast-racing", "theme": "high-contrast", "score": 68.333, "memory_bonus": 23.0, "composed_score": 91.333}, {"id": "cinematic-glow", "theme": "cinematic", "score": 63.0995, "memory_bonus": 0.0, "composed_score": 63.0995}, {"id": "aggressive-arcade", "theme": "aggressive", "score": 67.2459, "memory_bonus": 0.0, "composed_score": 67.2459}], "retriever": {"enabled": true, "source": "pipeline_logs_v1", "preferred_variant_id": "high-contrast-racing", "preferred_variant_theme": "high-contrast", "failure_reasons": ["QA failed after 3 attempts", "retry_builder"], "failure_tokens": ["immediate_game_over_visible_text"], "sample_size": 1}}, "contract": {"min_image_assets": 5, "min_render_layers": 4, "min_animation_hooks": 3, "min_procedural_layers": 3}, "art_direction": {"style_tag": "low-poly-neon", "motif": "neon-motion", "required_visual_keywords": ["neon-motion", "readable_silhouette", "high_contrast_hud"], "forbidden_visual_tokens": ["placeholder", "temp", "debug-ui", "plain-rectangle-only"], "asset_strategy_mode": "procedural_threejs_first", "asset_provider": "builtin_vector_pack", "external_image_generation": false, "asset_variant_count": 4, "asset_detail_tier": "enhanced"}}, "player_hp": 5, "player_speed": 320, "player_attack_cooldown": 0.25, "enemy_hp": 4, "enemy_speed_min": 130, "enemy_speed_max": 240, "enemy_spawn_rate": 1.5, "time_limit_sec": 180, "base_score_value": 25};
      const ASSET = {
        name: "neon_arcade",
        bg_top: "#08122f",
        bg_bottom: "#050915",
