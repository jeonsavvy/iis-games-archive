window.__iis_game_boot_ok = true;
      const CONFIG = {"mode": "webgl_three_runner", "title": "Apex Rush: 3D Circuit", "genre": "formula-racing-3d", "slug": "3d-ad926d", "accentColor": "#0EA5E9", "viewportWidth": 1280, "viewportHeight": 720, "safeAreaPadding": 24, "minFontSizePx": 14, "textOverflowPolicy": "ellipsis-clamp", "assetPack": {"name": "webgl_neon_highway", "bg_top": "#111827", "bg_bottom": "#020617", "horizon": "#13233f", "track": "#080f1d", "hud_primary": "#e2e8f0", "hud_muted": "#93c5fd", "player_primary": "#22c55e", "player_secondary": "#0f172a", "enemy_primary": "#f8fafc", "enemy_elite": "#f97316", "boost_color": "#22d3ee", "accent": "#0EA5E9", "particle": "#38bdf8", "sfx_profile": "synth_race", "sprite_profile": "neon"}, "assetManifest": {"schema_version": 1, "pack_name": "webgl_neon_highway", "genre_engine": "webgl_three_runner", "images": {"player": "./player.svg", "enemy": "./enemy.svg", "elite": "./elite.svg", "boost": "./boost.svg", "ring": "./ring.svg", "hazard": "./hazard.svg", "trail": "./trail.svg", "hud_frame": "./hud-frame.svg", "track_grid": "./track-grid.svg", "impact_flare": "./impact-flare.svg"}, "audio": {"profile": "synth_race"}, "asset_policy": {"mode": "procedural_threejs_first", "provider": "builtin_vector_pack", "external_image_generation": false}, "procedural_layers": ["gradient_background", "parallax_grid", "depth_fog", "particle_trails", "hud_glow_overlay", "decal_layers"], "asset_pipeline": {"automated": true, "source": "builtin_svg_asset_pipeline", "profile": "enhanced", "variant_count": 4, "selected_variant": "baseline-balanced", "selected_theme": "balanced", "selected_score": 71.8816, "selected_composed_score": 71.8816, "selected_memory_bonus": 0.0, "steps": ["derive_contract", "retrieve_prior_signals", "sample_visual_variants", "score_readability_contrast", "compose_variant_with_memory", "select_best_variant", "compile_svg_pack"], "candidates": [{"id": "baseline-balanced", "theme": "balanced", "score": 71.8816, "memory_bonus": 0.0, "composed_score": 71.8816}, {"id": "high-contrast-racing", "theme": "high-contrast", "score": 70.2313, "memory_bonus": 0.0, "composed_score": 70.2313}, {"id": "cinematic-glow", "theme": "cinematic", "score": 66.0374, "memory_bonus": 0.0, "composed_score": 66.0374}, {"id": "aggressive-arcade", "theme": "aggressive", "score": 69.0422, "memory_bonus": 0.0, "composed_score": 69.0422}], "retriever": {"enabled": true, "source": "pipeline_logs_v1", "preferred_variant_id": "None", "preferred_variant_theme": "None", "failure_reasons": [], "failure_tokens": [], "sample_size": 0}}, "contract": {"min_image_assets": 5, "min_render_layers": 4, "min_animation_hooks": 3, "min_procedural_layers": 3}, "art_direction": {"style_tag": "low-poly-synthwave", "motif": "neon-motion", "required_visual_keywords": ["neon-motion", "readable_silhouette", "high_contrast_hud"], "forbidden_visual_tokens": ["placeholder", "temp", "debug-ui", "plain-rectangle-only"], "asset_strategy_mode": "procedural_threejs_first", "asset_provider": "builtin_vector_pack", "external_image_generation": false, "asset_variant_count": 4, "asset_detail_tier": "enhanced"}}, "player_hp": 3, "player_speed": 380, "player_attack_cooldown": 1.5, "enemy_hp": 1, "enemy_speed_min": 240, "enemy_speed_max": 340, "enemy_spawn_rate": 0.6, "time_limit_sec": 180, "base_score_value": 100};
      const ASSET = {
        name: "neon_arcade",
        bg_top: "#08122f",
        bg_bottom: "#050915",
