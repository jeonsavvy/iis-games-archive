window.__iis_game_boot_ok = true;
      const CONFIG = {"mode": "comic_action_brawler_3d", "title": "Iron Strike: Poly Tournament", "genre": "3d-arena-fighter", "slug": "game-938aa6f8883d", "accentColor": "#0EA5E9", "viewportWidth": 1280, "viewportHeight": 720, "safeAreaPadding": 24, "minFontSizePx": 14, "textOverflowPolicy": "ellipsis-clamp", "assetPack": {"name": "comic_brawler", "bg_top": "#0e1423", "bg_bottom": "#050813", "horizon": "#2a2f5e", "track": "#101528", "hud_primary": "#e7ecf3", "hud_muted": "#93c5fd", "player_primary": "#3ad194", "player_secondary": "#0b1120", "enemy_primary": "#f9c0ca", "enemy_elite": "#f78611", "boost_color": "#aece60", "accent": "#0EA5E9", "particle": "#fde047", "sfx_profile": "comic_arcade", "sprite_profile": "comic"}, "assetManifest": {"schema_version": 1, "pack_name": "comic_brawler", "genre_engine": "comic_action_brawler_3d", "images": {"player": "./player.svg", "enemy": "./enemy.svg", "elite": "./elite.svg", "boost": "./boost.svg", "ring": "./ring.svg", "hazard": "./hazard.svg", "trail": "./trail.svg", "hud_frame": "./hud-frame.svg", "track_grid": "./track-grid.svg", "impact_flare": "./impact-flare.svg"}, "audio": {"profile": "comic_arcade"}, "asset_policy": {"mode": "procedural_threejs_first", "provider": "builtin_vector_pack", "external_image_generation": false}, "procedural_layers": ["gradient_background", "parallax_grid", "depth_fog", "particle_trails", "hud_glow_overlay", "decal_layers"], "asset_pipeline": {"automated": true, "source": "builtin_svg_asset_pipeline", "profile": "enhanced", "variant_count": 4, "selected_variant": "high-contrast-racing", "selected_theme": "high-contrast", "selected_score": 68.2277, "selected_composed_score": 68.2277, "selected_memory_bonus": 0.0, "steps": ["derive_contract", "retrieve_prior_signals", "sample_visual_variants", "score_readability_contrast", "compose_variant_with_memory", "select_best_variant", "compile_svg_pack"], "candidates": [{"id": "baseline-balanced", "theme": "balanced", "score": 67.367, "memory_bonus": 0.0, "composed_score": 67.367}, {"id": "high-contrast-racing", "theme": "high-contrast", "score": 68.2277, "memory_bonus": 0.0, "composed_score": 68.2277}, {"id": "cinematic-glow", "theme": "cinematic", "score": 63.1031, "memory_bonus": 0.0, "composed_score": 63.1031}, {"id": "aggressive-arcade", "theme": "aggressive", "score": 67.1387, "memory_bonus": 0.0, "composed_score": 67.1387}], "retriever": {"enabled": true, "source": "pipeline_logs_v1", "preferred_variant_id": "None", "preferred_variant_theme": "None", "failure_reasons": [], "failure_tokens": [], "sample_size": 0}}, "contract": {"min_image_assets": 5, "min_render_layers": 4, "min_animation_hooks": 3, "min_procedural_layers": 3}, "art_direction": {"style_tag": "ps1-retro-low-poly", "motif": "neon-motion", "required_visual_keywords": ["neon-motion", "readable_silhouette", "high_contrast_hud"], "forbidden_visual_tokens": ["placeholder", "temp", "debug-ui", "plain-rectangle-only"], "asset_strategy_mode": "procedural_threejs_first", "asset_provider": "builtin_vector_pack", "external_image_generation": false, "asset_variant_count": 4, "asset_detail_tier": "enhanced"}}, "player_hp": 5, "player_speed": 280, "player_attack_cooldown": 0.3, "enemy_hp": 3, "enemy_speed_min": 180, "enemy_speed_max": 250, "enemy_spawn_rate": 2.5, "time_limit_sec": 180, "base_score_value": 50};
      const ASSET = {
        name: "neon_arcade",
        bg_top: "#08122f",
        bg_bottom: "#050915",
